...
const Banner = () => {
    return (
        <div id='home' className="hero bg-base-100">
            <div className="hero-content flex-col lg:flex-row-reverse gap-x-32 pt-24 border-b">
                <img src={shamim} className="w-full lg:w-1/3 rounded-lg" alt='...' />
                <div className='w-full lg:w-1/2'>
                    <h2 className="text-2xl lg:text-2xl font-bold">Hello,</h2>
                    <h1 className="text-3xl lg:text-5xl font-bold mt-4">I'm <span className='text-primary'>Shamim Sarker</span></h1>
